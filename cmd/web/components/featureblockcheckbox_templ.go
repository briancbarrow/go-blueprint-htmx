...
func FeatureBlockCheckbox(props FeatureBlockProps) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/web/components/FeatureBlockCheckbox.templ`, Line: 13, Col: 17}
		}
		...
		for _, feature := range props.FeatureOptions {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/web/components/FeatureBlockCheckbox.templ`, Line: 28, Col: 22}
			}
